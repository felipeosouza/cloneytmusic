...
export default props => {
    ...
    const Songs = () => {
        ...
        const songs = songList.tracks.items.slice(40, 50)
    ...
    return (
        <View style={styles.container}>
            <View style={styles.titleContainer}>
                <Text style={{...titleTextStyle, color : 'white', fontSize : width * 0.08, marginBottom : width * 0.03}}>Forgotten favorites</Text>
            </View>
            <ScrollView 
